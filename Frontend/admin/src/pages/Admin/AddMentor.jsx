...
const AddMentor = () => {
    ...
    const [mentImg, setMentImg] = useState(false)
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                <div className='flex items-center gap-4 mb-8 text-gray-500'>
                    <label htmlFor="doc-img">
                        <img className='w-16 bg-gray-100 rounded-full cursor-pointer' src={mentImg ? URL.createObjectURL(mentImg) : assets.upload_area} alt="" />
                    </label>
                    <input onChange={(e) => setMentImg(e.target.files[0])} type="file" name="" id="doc-img" hidden />
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Fees</p>
                            <input onChange={e => setFees(e.target.value)} value={fees} className='border rounded px-3 py-2' type="number" placeholder='Doctor
                             fees' required />
                        </div>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <select onChange={e => setSpeciality(e.target.value)} value={speciality} className='border rounded px-2 py-2'>
                                ...
                                <option value="Health and Fitness">Pediatricians</option>
                                <option value="Spirtuality">Neurologist</option>
                            </select>
                        </div>
